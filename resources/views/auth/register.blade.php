...
<head>
    ...
    <title>Create Account - HealthFlow</title>
    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex w-1/2 relative bg-blue-900 overflow-hidden">
            ...
            <div class="relative z-20 flex flex-col justify-between p-16 w-full text-white">
                ...
                <div class="max-w-md">
                    <h2 class="text-3xl font-bold mb-4">Join HealthFlow</h2>
                    <p class="text-blue-100 text-lg mb-8">One secure account for all your healthcare needs.</p>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white overflow-y-auto">
            <div class="max-w-[440px] w-full">
                ...
                <div class="mb-10">
                    ...
                    <p class="mt-2 text-sm text-slate-500">Sign up to get started.</p>
                </div>
                ...
                <p class="mt-8 text-center text-sm text-slate-500">
                    Already have an ID? 
                    <a href="{{ route('login') }}" class="font-medium text-blue-900 hover:text-blue-700">Sign in</a>
                </p>
            </div>
        </div>
    </div>
