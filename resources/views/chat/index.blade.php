...
@section('header', __('messages.messages_title')).messages_title'))
...
<div class="max-w-7xl mx-auto h-[calc(100vh-140px)] px-4 sm:px-6 lg:px-8 py-6 mb-16 md:mb-0">
    <div class="chat-container flex font-sans h-full">
        ...
        <div class="flex-1 bg-gray-50 flex flex-col justify-center items-center text-center p-8 rounded-r-2xl">
            ...
            <h3 class="text-2xl font-bold text-gray-800 mb-2">{{ __('messages.welcome_messages') }}</h3>.welcome_messages') }}</h3>
            <p class="text-gray-500 max-w-sm mb-8">{{ __('messages.select_conversation') }}</p>
        </div>
    </div>
</div>
@endsection
