...
@section('header', __('messages.new_appointment'))
    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
                <h3 class="text-lg font-medium leading-6 text-gray-900">{{ __('messages.create_appointment') }}</h3>
                <p class="mt-1 text-sm text-gray-600">
                    {{ __('messages.create_appointment_desc') }}
                </p>
            </div>
        </div>
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6">
                                <label for="patient_id" class="block text-sm font-medium text-gray-700">{{ __('messages.patient') }}</label>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="doctor_id" class="block text-sm font-medium text-gray-700">{{ __('messages.doctors') }}</label>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="appointment_date" class="block text-sm font-medium text-gray-700">{{ __('messages.date') }}</label>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="appointment_time" class="block text-sm font-medium text-gray-700">{{ __('messages.time') }}</label>
