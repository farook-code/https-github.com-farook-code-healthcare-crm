...
<div class="max-w-4xl mx-auto p-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h2 class="text-xl font-bold text-gray-800 mb-6">Edit Package: {{ $plan->name }}</h2>
            ...
            <div class="grid grid-cols-1 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text" name="slug" id="slug" value="{{ old('slug', $plan->slug) }}" required 
                     ...
                     <p class="text-xs text-gray-500 mt-1">Important: Changing this may affect feature access logic (expects 'basic', 'premium', 'pro').</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="duration_in_days" id="duration_in_days" value="{{ old('duration_in_days', $plan->duration_in_days) }}" required 
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm">
                    ...
                    <div id="features-container" class="space-y-3">
                        @forelse($plan->features ?? [] as $feature)
                             <div class="flex items-center gap-2">
                                <input type="text" name="features[]" value="{{ $feature }}" class="flex-1 rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm">
