    ...
    <div class="bg-white dark:bg-slate-800 shadow rounded-lg overflow-hidden">
        <form action="{{ route('admin.clinics.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" required placeholder="e.g. Downtown Dental Care"
            ...
            <div>
                ...
                <div class="mt-1 flex rounded-md shadow-sm">
                    <input type="text" name="subdomain" id="subdomain" required placeholder="downtown"
                ...
                <p class="mt-1 text-xs text-slate-500">Unique identifier for this clinic's URL.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" required placeholder="admin@clinic.com"
                           class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-slate-700 dark:border-slate-600 dark:text-white sm:text-sm">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="phone" id="phone" placeholder="(555) 123-4567"
                           class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-slate-700 dark:border-slate-600 dark:text-white sm:text-sm">
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="address" id="address" rows="3"
                          class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-slate-700 dark:border-slate-600 dark:text-white sm:text-sm"></textarea>
            </div>
